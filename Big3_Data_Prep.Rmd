...
get_cleaned_nba_stats <- function(year) {
  ...
  get_nba_roster2 <- function(year) {
    ...
    # Print the structure and column names for debugging
    print("Per Game Stats Table:")
    print(str(roster_table))  # Show structure of the data frame
    print("Per Game Stats Column Names:")
    print(colnames(roster_table))
  ...
  get_nba_advanced_stats <- function(year) {
    ...
    # Print the structure and column names for debugging
    print("Advanced Stats Table:")
    print(str(advanced_stats_table))  # Show structure of the data frame
    print("Advanced Stats Column Names:")
    print(colnames(advanced_stats_table))
  ...
  # Check for available columns to merge
  merge_columns <- c("Rk", "Player", "Pos", "Age", "Tm", "G")
  
  # Print columns to be used for merging
  print("Columns to merge on:")
  print(merge_columns)

  # Check if the columns exist in both data frames
  ...
  # Merge the two datasets by matching available columns
